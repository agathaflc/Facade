...
public class PauseScript : MonoBehaviour
{
    ...
    public void BackToMainMenu()
    {
        ...
        StartCoroutine(
            UIUtils.GraduallyChangeCanvasGroupAlpha(areYouSureScreen, 1, true, 0.05f, 0.025f, areYouSureLock));
    }
    ...
    {
        StartCoroutine(
            UIUtils.GraduallyChangeCanvasGroupAlpha(areYouSureScreen, 0, false, 0.05f, 0.025f, areYouSureLock));
    }
    ...
    public void ConfirmQuit()
    {
        ...
        else if (menuOrQuit.Equals(QUIT_GAME)) DataController.EraseFlagDataAndQuit();
    }
